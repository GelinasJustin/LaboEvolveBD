	...
	ALTER TABLE Musique.Chanteur ADD ChanteurID int
	GO
	...
	GO
	ALTER TABLE Musique.Chanteur ADD CONSTRAINT FK_Chanson_ChanteurID FOREIGN KEY (ChanteurID) REFERENCES Musique.Chanteur (ChanteurID) ON DELETE CASCADE
	GO
